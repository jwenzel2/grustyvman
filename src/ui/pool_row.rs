...
mod imp {
    ...
    impl ObjectSubclass for PoolRow {
        const NAME: &'static str = "GrustyvmanPoolRow";
        type Type = super::PoolRow;
        type ParentType = gtk::Box;
    }

    impl ObjectImpl for PoolRow {
        fn constructed(&self) {
    ...
    impl WidgetImpl for PoolRow {}
    impl BoxImpl for PoolRow {}
}

glib::wrapper! {
    pub struct PoolRow(ObjectSubclass<imp::PoolRow>)
...
impl PoolRow {
    ...
    pub fn bind(&self, pool: &crate::models::pool_object::PoolObject) {
        let imp = self.imp();
