...
mod imp {
    ...
    #[properties(wrapper_type = super::PoolObject)]
    ...
    impl ObjectSubclass for PoolObject {
        const NAME: &'static str = "GrustyvmanPoolObject";
        type Type = super::PoolObject;
        type ParentType = glib::Object;
    }

    #[glib::derived_properties]
    impl ObjectImpl for PoolObject {}
}

glib::wrapper! {
    pub struct PoolObject(ObjectSubclass<imp::PoolObject>);
}

impl PoolObject {
    pub fn new(info: &crate::backend::types::PoolInfo) -> Self {
        glib::Object::builder()
    ...
    pub fn update_from(&self, info: &crate::backend::types::PoolInfo) {
